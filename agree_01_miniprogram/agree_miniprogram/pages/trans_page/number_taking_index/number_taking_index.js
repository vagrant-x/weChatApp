...
Page({
  ...
  bt_scan: function () {
    ...
    wx.scanCode({
      success(res) {
        ...
        let next_page_url = "/pages/trans_page/tnm_scan_idr/tnm_scan_idr" + "?controllerId=" + that.data.bt_scan_data.result
  ...
  bt_touch: function () {
    // wx.navigateTo({
    //   url: '/pages/trans_page/tnm_scan_idr/tnm_scan_idr',
    // })
    // return
            ...
            wx.showModal({
              ...
              success(res1) {
                if (res1.confirm) {
                  ...
                  let next_page_url = "/pages/trans_page/tnm_scan_idr/tnm_scan_idr"
                  wx.navigateTo({
